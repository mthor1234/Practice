		...
		for(int i = 0; i < grid.length * grid.length; i++){
			...
			if(foundTarget == true){
				for(Node tempNode: closedList){
					System.out.print("Path: " + "(" + tempNode.row + ", " + tempNode.col + "), " + " ->");
				}
				return;
			}
